...
function secretSettings() { 
    ...
    {
       if(!settings[2])document.getElementById('welcometoosu').play(); else document.getElementById('triangles').play();
       ...
       if(settings[2])
           document.getElementById('body').style.animation = 'zoom-in-zoom-out 0.65s ease infinite';
...
function playDiscordo() {
    document.getElementById('discordo').play();
...
function testButton()
{
    const obj = document.getElementById('settings-button');
    const dot = document.getElementById('settings-button-dot');

    settings[0] = !settings[0];
    if(settings[0]) dot.style.backgroundColor = 'rgb(89, 231, 103)'; else dot.style.backgroundColor = 'rgb(227, 76, 76)';
}
...
function trianglesOpening()
{
    ...
    if(settings[2]) dot.style.backgroundColor = 'rgb(89, 231, 103)'; else dot.style.backgroundColor = 'rgb(227, 76, 76)';
}
...
function showPostBadges()
{
    ...
    if(showBadges) document.getElementById('medals-settings-dot').style.backgroundColor = 'rgb(89, 231, 103)'; else document.getElementById('medals-settings-dot').style.backgroundColor = 'rgb(227, 76, 76)';
}
...
{
    if(settings[2] && !byPasseSongVolume)
    {
